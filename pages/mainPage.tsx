            ...
            <section>
                <div >
                    <div className={style.container_section}>
                        <div id="imageContainer" className={style.img_position}>
                            <Image layout='fill' src={imageT} alt="image" />
                        </div>
                        <svg className={style.svg_position} width="802" height="531" viewBox="0 0 802 531" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className={style.svg_front_position} width="666" height="487" viewBox="0 0 666 487" fill="none" xmlns="http://www.w3.org/2000/svg">
